...
- `!streamer <add|remove> <twitch_nick> [<channel_name>]` - Adds or removes or twitch streamer from the watch list for the specified channel.
- `!streamers` - Show a list of all watched twitch streamers on the current server..
